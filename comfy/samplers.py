...
KSAMPLER_NAMES = ["euler_test","euler", "euler_ancestral_test", "euler_ancestral", "heun", "heunpp2","dpm_2", "dpm_2_ancestral",
...
class KSAMPLER(Sampler):
    ...
    def sample(self, model_wrap, sigmas, extra_args, callback, noise, latent_image=None, denoise_mask=None, disable_pbar=False, diffusion_step=None):
        ...
        samples = self.sampler_function(model_k, noise, sigmas, extra_args=extra_args, callback=k_callback, disable=disable_pbar, **self.extra_options, diffusion_step=diffusion_step)
        return samples
...
def ksampler(sampler_name, extra_options={}, inpaint_options={}):
    if sampler_name == "dpm_fast":
        ...
        sampler_function = getattr(k_diffusion_sampling, "sample_{}".format(sampler_name)) #<function sample_euler_test at 0x000001DA75ED4CC0>
...
def sample(model, noise, positive, negative, cfg, device, sampler, sigmas, model_options={}, latent_image=None, 
           denoise_mask=None, callback=None, disable_pbar=False, seed=None, diffusion_step=None):
...
class KSampler:
    ...
    def sample(self, noise, positive, negative, cfg, latent_image=None, start_step=None, last_step=None, force_full_denoise=False, denoise_mask=None, sigmas=None, callback=None, disable_pbar=False, seed=None):
        ...
        return sample(self.model, noise, positive, negative, cfg, self.device, sampler, sigmas, self.model_options, latent_image=latent_image, denoise_mask=denoise_mask, callback=callback, 
                      disable_pbar=disable_pbar, seed=seed, diffusion_step=self.diffusion_step)
