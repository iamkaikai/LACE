    ...
    for x in inputs:
        ...
        if isinstance(input_data, list):
            ...
            if input_unique_id not in outputs:
                print(f"Warning: {input_unique_id} not in outputs.")
                input_data_all[x] = (None,)
                continue
            if output_index >= len(outputs[input_unique_id]):
                print(f"Error: Output index {output_index} out of range for {input_unique_id}.")
                continue
